...
const TrackLoader = ({ isLoading, handleGetRandomTrack, handleEndGame, isFinalRound }) => {
  const buttonClass = isFinalRound
    ? "px-4 py-2 mt-4 bg-info hover:bg-info-focus text-white rounded transition-colors"
    : "px-4 py-2 mt-4 bg-primary hover:bg-primary-focus text-white rounded transition-colors";
