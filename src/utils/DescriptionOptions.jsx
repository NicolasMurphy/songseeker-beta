const getDescriptionOptions = () => {
  return [
    ...
    {
      country: "Argentina",
      description: `[Translated by ChatGPT, with some corrections]\n"Zamba de mi esperanza", also known as "De mi esperanza", is a popular folk song from Argentina. The song was written by Luis Profili from Mendoza, back in the 1950s, but it was formally registered under the pseudonym Luis H. Morales in 1964. Jorge Cafrune initially popularized the song, which quickly gained popularity both in Argentina and around the world ... This song is recognized as one of the most beloved piece of Argentine folk music, and it ranks among the thirteen most popular songs in Argentina.\nAlthough the song's lyrics don't have any political or social context, it was prohibited by the military dictatorship that took power in Argentina in 1976. In 1978, Jorge Cafrune and several others performed the song, defying the ban at the public's behest during the Cosquín Festival. He publicly declared, "Even if it is not on the authorized list, if my people request it, I will sing it". Sadly, a few days later, he was killed in a hit-and-run incident involving a Rastrojero van. There have been grave suspicions that this might have been an assassination arranged by the military regime.`,
      link: "https://es.wikipedia.org/wiki/Zamba_de_mi_esperanza",
    },
    {
      country: "Ireland",
      description: `It is presumed that The Swallowtail Jig was written in the middle of the Nineteenth Century and came to America with the Irish migrant caravan of that era. It is also known as The Dancingmaster and both names come from the men’s coat that forks in the back like the tail of the swallow.`,
      link: "https://mikepowernyc.com/2018/10/29/the-swallowtail-jig/",
    },
    {
      country: "Germany",
      description: `"In München steht ein Hofbräuhaus" (German for "There's a Hofbräuhaus in Munich") is the title of the Hofbräuhaus-Lied ("Hofbräuhaus song") composed in 1935, which is today one of the best known drinking songs throughout the world. The refrain of the schlager song goes: "In München steht ein Hofbräushaus - oans, zwoa, g'suffa", Bavarian dialect German for "There's a Hofbräuhaus in Munich - one, two, let's drink!".\nThe song was composed by Wilhelm "Wiga" Gabriel from Berlin (1897 - 1964). According to legend, Gabriel found the melody to the text written by his friend Klaus Siegfried from Bad Hindelang in the Café am Zoo in Berlin. As the composer did not have any paper at hand, he wrote the notes on the title page of the Berliner Illustrierten newspaper. The start of the melody resembles the Munich city hymn Solang der alte Peter. Gabriel is said to have resorted to this folk song for the melody. The Hofbräuhaus song, musically a waltz, was first performed at the Wurstmarkt in Bad Dürkheim in 1936. It developed to a carnival melody at the carnival time in the next year and found its way to the Hofbräuhaus, where Gabriel conducted it himself and was rewarded with a giant mug of beer.`,
    ...
    {
      country: "China",
      description: `Mo Li Hua ('Jasmine Flower') is a Chinese folk song from the Jiangnan region. The song dates back to the 18th century. Over time, many regional variations were created, and the song gained popularity both in China and abroad.\nIt has been used during events such as 2004 Summer Olympics, 2008 Summer Olympics and 2010 Shanghai Expo opening ceremony, and during the 2011 Chinese protests.`,
